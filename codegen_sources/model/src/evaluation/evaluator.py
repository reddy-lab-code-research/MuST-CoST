...
class Evaluator(object):
    ...
    def run_all_evals_cont(self, trainer, precont_topk, cont_lambda, max_tok_num, cont=True):
        """
        Run all evaluations.
        """
        params = self.params
        ...
        with torch.no_grad():
            ...
            for data_set in EVAL_DATASET_SPLITS:#EVAL_DATASET_SPLITS: ["test"]
                ...
                for keys in set(
                    ...
                    self.evaluate_mt(
                        ...
                        spans,
                        cont=cont, 
                        precondition_topk=precont_topk, 
                        condition_lambda=cont_lambda,
...
# precondition_topk = 10, condition_lambda = 0.5,
    def evaluate_mt(
        ...
        eval_subtoken_score,
        span,
        cont=False, precondition_topk=10, condition_lambda=0.7, max_tok_num=20,
        deobfuscate=False,
